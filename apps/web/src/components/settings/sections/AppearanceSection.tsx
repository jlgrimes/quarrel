      ...
      <Card className='mb-6 border-white/10 bg-bg-tertiary/65 py-0'>
        ...
        <div className="flex gap-3">
          <Button
            ...
            className={`flex flex-1 flex-col items-center border-2 p-4 transition-colors ${
              theme === 'dark'
                ? 'border-brand bg-bg-tertiary'
                : 'border-transparent bg-bg-tertiary hover:border-bg-neutral'
            }`}
          >
            <div className="mb-2 h-12 w-12 bg-bg-primary" />
          ...
          >
            <div className="mb-2 h-12 w-12 bg-white" />
        ...
        <div className="flex gap-3">
          {(['small', 'normal', 'large'] as const).map((size) => (
            <Button
              ...
              className={`flex-1 border-2 px-4 py-3 text-center font-medium capitalize transition-colors ${
                fontSize === size

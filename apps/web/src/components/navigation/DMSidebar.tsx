...
export default function DMSidebar() {
  ...
  return (
    <Sidebar side="left" collapsible="offcanvas">
      <SidebarHeader className="h-12 flex-row items-center border-b border-[#1e1f22] px-4 py-0">
        <Input
          type="text"
      ...
      <SidebarContent>
          ...
          <SidebarMenu>
            <SidebarMenuItem>
              <SidebarMenuButton
                ...
                className={conversationId ? 'text-[#949ba4] hover:text-[#dbdee1]' : ''}
              >
        ...
        <SidebarGroup className="px-2">
          <SidebarGroupLabel className="px-2 text-xs font-semibold uppercase text-[#949ba4]">
            Direct Messages
          </SidebarGroupLabel>
          <SidebarGroupContent>
            <SidebarMenu>
